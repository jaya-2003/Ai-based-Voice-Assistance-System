...
if(os.path.exists('password.txt')==False):
    ...
    fun_talk("Sir,this your first time please enter your password for future reference")
    p=input("password:")
    file.write(p)
    file.close()
...
'''def get_command():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            print("PA could not understand audio")
            return "None"
...
def get_command():
    ...
    model = Model(r"C:\Users\B Jaya krishna\Desktop\mini prj 2\vosk-model-en-us-daanzu-20200905")
    ...
    while(True):
        ...
        if recognizer.AcceptWaveform(data):
           ...
           t=(f"{text[14:-3]}")
           print("The User said:",t)
           break
    return t

def sensitive():
    fun_talk('please identify yourself')
    a=input("enter yor pin")
...
if __name__ == '__main__':
    ...
    while True: 
        ...
        if 'wikipedia' in query:
        ...
        elif 'open black board' in query:
            ...
            os.startfile(r"C:\Users\B Jaya krishna\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Visual Studio Code\Visual Studio Code.lnk")
            ...
            try:
                ...
                fun_talk(f"Mentioned city is out of bounds")
                pass
        ...
        elif 'thats it' in query or 'thank you'in query:
            fun_talk("its my pleasure helping you")
            break
